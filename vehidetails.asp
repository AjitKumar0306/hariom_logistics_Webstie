...
rs.Open "SELECT * FROM vehical", conn
%>

<table border="1" style="margin-left:30%; margin-top:55px;width:Auto;">
<th>Vehical No</th><th>Vehical Name</th><th>Vehical Type</th><th>Availabilty</th>
<%do until rs.EOF%>
