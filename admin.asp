...
rs.Open "SELECT fname,mobile,city,email,gen,status FROM signup where status = 0", conn
%>

<table border="1" width="50%" style="margin-left:30%; margin-top:55px;">
<th>First Name</th><th>Mobile Number</th><th>City</th><th>Email</th><th>Gender</th><th>Activate</th>
<%do until rs.EOF%>
