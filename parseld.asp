...
rs.Open "SELECT * FROM parsel", conn
%>

<table border="1"  style="margin-left:20%; margin-top:55px;width:Auto;">
<th>Parsel ID</th><th>User Name</th><th>Mobile No</th><th>Source</th><th>Destination</th><th>Comodity</th><th>No.Of Packets</th><th>Weight</th><th>Status</th>
<%do until rs.EOF%>
