...
rs.Open "SELECT fname,lname,mobile,city,state,email,gen,addres,status FROM signup where fname <> 'admin' ", conn
%>

<table border="1" style="margin-left:15.5%; margin-top:55px;width:Auto;">
<th>First Name</th><th>Last Name</th><th>Mobile</th><th>City</th><th>State</th><th>Email</th><th>Gender</th><th>Address</th><th>Status</th>
<%do until rs.EOF%>
